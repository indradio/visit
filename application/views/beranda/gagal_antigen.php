          ...
          <div class="content-center">
            <div class="row">
              <div class="col-md-6 ml-auto mr-auto text-center">
                ...
                <h5 class="description">Masa berlaku hasil test ANTIGEN maximal 2 Hari.</h5>
                <h5 class="description"><i>The validity period of the ANTIGEN test results is a maximum of 2 days.</i></h5>
              </div>
            </div>
          </div>
        </div>
